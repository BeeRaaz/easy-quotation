...
function Services() {
  return (
    <main id="services" className="relative -z-10 pt-36 h-screen px-32">
      <section id="firstSection" className="h-screen">
        <div id="imageSection">
      ...
      <section id="secondSection" className="h-screen">
        <div>
        ...
        <div className="border-t-2 border-t-[#F5CB47]">
          ...
          <p className="text-xl pt-14 pb-3">
      ...
      <section id="thirdSection" className="h-screen">
