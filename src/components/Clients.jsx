...
function Clients() {
  return (
    <article className="pb-14">
      ...
      <div id="logoContainer" className="flex items-center justify-around">
      <div id="logoTop" className="flex flex-col pb-10 items-center">
        ...
        <div id="logoBottom" className="flex flex-col pb-10 items-center">
